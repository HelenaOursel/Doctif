...
export const FR = {
  ...
  'nav.dashboard.desc': 'Contrats actifs, factures récentes, échéances proches',
  ...
  'nav.calendar.desc': 'Toutes vos échéances détectées automatiquement',
  'nav.alerts': 'Alertes',
  'nav.alerts.desc': 'Notifications à J-30, J-7 et J-1',
  'nav.contracts': 'Contrats',
  'nav.contracts.desc': 'Vérification des clauses et score de risque',
  'nav.savings': 'Économies',
  'nav.savings.desc': 'Doublons, abonnements dormants, augmentations',
  'nav.renewal': 'Renouvellement',
  'nav.renewal.desc': 'Offres concurrentes avant expiration',
  'nav.anomalies': 'Anomalies',
  'nav.anomalies.desc': 'Factures et prélèvements inhabituels',
  ...
  'nav.timeline.desc': 'Votre histoire administrative année par année',
  'nav.chat': 'Assistant',
  'nav.chat.desc': 'Posez vos questions administratives',
  'nav.archive': 'Archivage à vie',
  'nav.archive.short': 'Archives',
  'nav.archive.desc': 'Conservation longue durée et export',
  'nav.settings': 'Paramètres',
  'nav.settings.short': 'Réglages',
  'nav.settings.desc': 'Profil, données et réinitialisation',
  ...
  'dashboard.subtitle': 'Votre situation administrative en un coup d’œil.',
...
export const EN: Partial<Dictionary> = {
  ...
  'nav.dashboard.desc': 'Active contracts, recent bills, upcoming deadlines',
  ...
  'nav.calendar.desc': 'Every deadline detected automatically',
  'nav.alerts': 'Alerts',
  'nav.alerts.desc': 'Notifications at D-30, D-7 and D-1',
  'nav.contracts': 'Contracts',
  'nav.contracts.desc': 'Clause review and risk score',
  'nav.savings': 'Savings',
  'nav.savings.desc': 'Duplicates, dormant subscriptions, price rises',
  'nav.renewal': 'Renewal',
  'nav.renewal.desc': 'Competing offers before expiry',
  'nav.anomalies': 'Anomalies',
  'nav.anomalies.desc': 'Unusual bills and direct debits',
  'nav.tax': 'Tax centre',
  'nav.tax.short': 'Tax',
  ...
  'nav.timeline.desc': 'Your admin history, year by year',
  'nav.chat': 'Assistant',
  'nav.chat.desc': 'Ask your admin questions',
  'nav.archive': 'Lifetime archive',
  'nav.archive.short': 'Archive',
  'nav.archive.desc': 'Long-term retention and export',
  'nav.settings': 'Settings',
  'nav.settings.short': 'Settings',
  'nav.settings.desc': 'Profile, data and reset',
  ...
  'dashboard.subtitle': 'Your admin situation at a glance.',
